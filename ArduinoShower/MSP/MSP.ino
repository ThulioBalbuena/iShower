...
SoftwareSerial mySerial1(18, 19); //PINOS QUE EMULAM A SERIAL, ONDE O PINO 6 É O RX E O PINO 7 É O TX

char ssid[] = "TFTV"; //VARIÁVEL QUE ARMAZENA O NOME DA REDE SEM FIO
char pass[] = "thathufla";//VARIÁVEL QUE ARMAZENA A SENHA DA REDE SEM FIO
...
void setup(){
  ...
  mySerial1.begin(115200); //INICIALIZA A SERIAL PARA O ESP8266
  WiFi.init(&mySerial1); //INICIALIZA A COMUNICAÇÃO SERIAL COM O ESP8266
